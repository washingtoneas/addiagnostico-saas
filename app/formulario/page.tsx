...
export default function FormularioPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push("/relatorio-gratuito")
  }
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-3xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-slate-800 mb-4">Preencha os dados da sua campanha</h1>
            <p className="text-slate-600">
              Insira as métricas da sua campanha do Facebook Ads para receber o diagnóstico gratuito
            </p>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="valorGasto">Valor gasto total *</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="orcamentoDiario">Orçamento diário</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500">R$</span>
                      <Input
                        id="orcamentoDiario"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="cpm">CPM (Custo por Mil Impressões) *</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500">R$</span>
                      <Input
                        id="cpm"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="cpc">CPC (Custo por Clique) *</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500">R$</span>
                      <Input
                        id="cpc"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="cpa">CPA (Custo por Aquisição) *</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500">R$</span>
                      <Input
                        id="cpa"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="roas">ROAS (Retorno sobre Gasto) *</Label>
                    <Input
                      id="roas"
                      type="number"
                      step="0.1"
                ...
                <div className="pt-4">
                  ...
                  <p className="text-center text-sm text-slate-500 mt-2">* Campos obrigatórios para análise básica</p>
                </div>
              </form>
            </CardContent>
          </Card>
